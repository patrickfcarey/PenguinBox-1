...
#define NV2A_PROF_COUNTERS_XMAC \
    ...
    _X(NV2A_PROF_S2T_MISS_NOSURF) \
    _X(NV2A_PROF_S2T_MISS_WITHIN) \
    _X(NV2A_PROF_S2T_MISS_MIPS) \
    _X(NV2A_PROF_S2T_MISS_PITCH) \
    _X(NV2A_PROF_S2T_MISS_DIMS) \
    _X(NV2A_PROF_S2T_MISS_CUBEMAP) \
    _X(NV2A_PROF_S2T_MISS_FORMAT) \
    _X(NV2A_PROF_S2T_EXT_COPY) \
    _X(NV2A_PROF_S2T_EXT_REGIONS) \
    _X(NV2A_PROF_S2T_EXT_PARTIAL) \
    _X(NV2A_PROF_S2T_EXT_QUAD) \
    _X(NV2A_PROF_S2T_EXT_BOUNCE) \
    _X(NV2A_PROF_S2T_REJ_TEXSHAPE) \
    _X(NV2A_PROF_S2T_REJ_SWIZSURF) \
    _X(NV2A_PROF_S2T_REJ_PITCH) \
    _X(NV2A_PROF_S2T_REJ_BPP) \
    _X(NV2A_PROF_S2T_REJ_ALIGN) \
    _X(NV2A_PROF_S2T_REJ_OVERFLOW) \
    _X(NV2A_PROF_S2T_REJ_NONE_RESIDENT) \
    _X(NV2A_PROF_ALIAS_KEPT) \
    _X(NV2A_PROF_ZC_REJ_FMT) \
    _X(NV2A_PROF_ZC_REJ_ZETA_BOUND) \
    _X(NV2A_PROF_ZC_REJ_ZETA_SURF) \
    _X(NV2A_PROF_ZC_REJ_SHAPE) \
    _X(NV2A_PROF_ZC_FLUSHES) \
