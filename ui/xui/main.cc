...
void xemu_hud_update(void)
{
    ...
    if (!ImGui::IsWindowFocused(ImGuiFocusedFlags_AnyWindow) &&
        ...
        /* SBC cockpit overlay toggle (default F3) — inert unless the
         * keyboard drives a Steel Battalion controller. */
        SbcOverlayProcessHotkey();

        /* F5-F8 are cockpit toggles when the keyboard drives a Steel
         * Battalion controller (ISS-B12) — snapshots stay reachable via
         * the Snapshots menu. */
